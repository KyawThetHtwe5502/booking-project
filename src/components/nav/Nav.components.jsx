...
import { BsBell, BsInfoCircle, BsPower, BsMoonStars, BsCircleHalf, BsGear } from "react-icons/bs";

import NavigationComponents from '../update/Navigation.components';
import { Badge } from '../ui/badge';
import { CiBookmarkCheck, CiHeart, CiLight } from "react-icons/ci";
        ...
        <div className='flex justify-between items-center w-full'>
          ...
          <div className='flex items-center gap-x-4'>
            <div className='flex items-center gap-x-1'>
              <Button className="bg-blue-100 text-blue-600 hover:bg-blue-100">
                <FaHotel className="mr-2 h-4 w-4" /> Hotel
              </Button>
              <Button className="bg-white text-slate-600 hover:bg-blue-100 hover:text-blue-600">
                <MdFlight className="mr-2 h-4 w-4 rotate-90" /> Hotel
              </Button>
              <Button className="bg-white text-slate-600 hover:bg-blue-100 hover:text-blue-600">
            ...
            <div className='flex items-center gap-x-4'>
              <DropDownComponents button={<div className='bg-white p-1 relative '>
              <Button className=" bg-accent hover:bg-accent text-slate-700   inline-flex gap-x-1 items-center"><BsBell />
              ...
              <DropDownComponents button={
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="flex items-center gap-x-2 px-4"><CiBookmarkCheck className='text-xl' /> My Bookings</DropdownMenuItem>
                <DropdownMenuItem className="flex items-center gap-x-2 px-4"><CiHeart className='text-xl' /> My Wishlist</DropdownMenuItem>
                <DropdownMenuItem className="flex items-center gap-x-2 px-4"> <BsGear className='text' />Settings</DropdownMenuItem>
                <DropdownMenuItem className="flex items-center gap-x-2 px-4"><BsInfoCircle className='text' /> Help Center</DropdownMenuItem>
                <DropdownMenuItem className="flex items-center gap-x-2 px-4"><BsPower className='text' /> Sign Out</DropdownMenuItem>
                <DropdownMenuSeparator />
                <div className='flex justify-between items-center gap-x-4 p-2'>
                  <span>Mode:</span>
                  <span className='space-x-4'>
                    <Button className="bg-white hover:bg-accent text-slate-800 hover:text-blue-700"><CiLight /></Button>
                    <Button className="bg-white  hover:bg-accent text-slate-800 hover:text-blue-700"><BsMoonStars /></Button>
                    <Button className="bg-white hover:bg-accent text-slate-800 hover:text-blue-700"><BsCircleHalf /></Button>
                  </span>
                </div>

...
const TestimonialsHome = () => {
    ...
    return (
        <section className='container mx-auto xl:p-24'>
            <Carousel opts={{
                align: "start",
                loop: true
            }}
            ...
            >
                ...
                <CarouselPrevious className=" w-12 h-12 bg-accent  hover:bg-white border-2 border-slate-700 dark:border-white left-0 top-1/2 -translate-x-[100%] group-hover:translate-x-0 duration-300 transition" />
                <CarouselNext className=" w-12 h-12 bg-accent hover:bg-white border-2 border-slate-700 dark:border-white right-0 top-1/2 translate-x-32 group-hover:translate-x-0 duration-300 transition" />
            </Carousel>

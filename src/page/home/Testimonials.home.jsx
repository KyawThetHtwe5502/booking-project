    ...
    return (
        <section className='container mx-auto p-24'>
            ...
            >
                <CarouselContent >
                    {testimonials.map((i) => (
                        <CarouselItem className=" ms-10 pl-12" key={i.id}>

                            <div className="grid grid-cols-12 items-center">
                                <div className=' relative col-span-6 z-10  mr-28'>
                                    ...
                                    <span className='absolute bottom-0 right-0 -z-10  translate-x-16'>
                                ...
                                <div className='col-span-6'>
                                    <FaQuoteLeft className='text-5xl mb-6 ms-4 text-blue-500' />
                ...
                <CarouselPrevious className=" w-12 h-12 bg-accent  hover:bg-white border-2 border-slate-700 left-0 top-1/2 -translate-x-[100%] group-hover:translate-x-0 duration-300 transition" />
                <CarouselNext className=" w-12 h-12 bg-accent hover:bg-white border-2 border-slate-700 right-0 top-1/2 translate-x-32 group-hover:translate-x-0 duration-300 transition" />
            </Carousel>

    ...
    return (
        <section className='container mx-auto mb-8'>
            <div className='grid grid-cols-12  items-center gap-x-8'>
                ...
                <div className='col-span-6 p-6 bg-accent rounded-xl relative'>
                    <h3 className='font-heading font-bold text-4xl mb-5'>Send us message</h3>
                    ...
                    <Checkbox id="check" name="check" className="border-gray-500 focus:bg-gray-500" /> 
                    <Label className="text-base text-gray-500 font-normal" htmlFor="check">
                    By submitting this form you agree to our terms and conditions.
                    </Label>
                    </div>
                    <Button type="submit" className="self-start text-base font-bold">Send Message</Button>   
                    </form>
                    <span className='absolute bottom-0 right-0 translate-x-2 translate-y-[25%]'>
                    <svg className="fill-yellow-600" width="104.2px" height="95.2px">
